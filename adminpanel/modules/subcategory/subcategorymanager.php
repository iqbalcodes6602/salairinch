...
<body>
    <div id="main-wrapper">
        ...
        $category = mysqli_query($mysqli_user, $query);

        $options = "";
        while ($category_data = mysqli_fetch_assoc($category)) {
            $options .= '<option value="' . $category_data['id'] . '">' . $category_data['title'] . '</option>';
        }
        ?>
                                ...
                                <form id="filter">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <button type="button" class="btn btn-primary w-100" data-toggle="modal" data-target="#exampleModal">Add Sub-Category</button>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="inputEmail4">Category ID</label>
                                            <select id="filter_categoryid" class="select2" width="100%">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form id="addsubcategory" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="inputEmail4">Catergory Id</label>
                                        <select name="categoryid" class="select2" width="100%">
                                            <?= $options ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-3">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary upload_btn">Add Sub-Category</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="subcategoryupdate" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="inputEmail4">Category ID</label>
                                        <!-- <input type="text" class="form-control" name="categoryid" placeholder="Category ID" required> -->
                                        <select name="categoryid" class="select2" width="100%">
                                            <?= $options ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary update_btn">Update Sub-Category</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script src="subcategorymanager.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script>
        $('#zero_config').DataTable();
        $('#filter_domain').select2();
        $('#filter select[id="filter_categoryid"]').select2();
        $('#addsubcategory select[name="status"]').select2();
        $('#addsubcategory select[name="categoryid"]').select2();
        $('#subcategoryupdate select[name="categoryid"]').select2();
        $('#subcategoryupdate select[name="status"]').select2();
        $('#addsubcategory select[name="domain"]').select2();
        $('#addsubcategory select[name="type"]').select2();
        $('.select2').css('width', '100%');
        $("#subcategoryupdate select[name=\"stockids[]\"]").select2();
