...
<body>
                                ...
                                <form id="filter" >
                                    <div class="form-row">
                                        <div class="form-group col-md-10">
                                            <h4 class="page-title">Registered Setting</h4>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <button type="button" class="btn btn-primary w-100 d-none" data-toggle="modal" data-target="#exampleModal">Add Setting</button>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputEmail4">Slug</label>
                                            <input type="text" class="form-control" id="filter_slug" placeholder="Slug">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4">Value</label>
                                            <input type="text" class="form-control" id="filter_value" placeholder="Value">
                                        </div>
                                    </div>
                                    <div class="form-row">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="addsetting" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label for="inputEmail4">Slug</label>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary upload_btn">Add Setting</button>
                                    </div>
                                </div>
                            </form> 
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="settingupdate" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label for="inputEmail4">Slug</label>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary update_btn">Update Setting</button>
                                    </div>
                                </div>
                            </form> 
                        </div>
    ...
    <script src="settingmanager.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script>
        $('#zero_config').DataTable();
        $('#filter_domain').select2();
        $('#addsetting select[name="status"]').select2();
        $('#settingupdate select[name="status"]').select2();
        $('#addsetting select[name="type"]').select2();
        $('.select2').css('width','100%');
        $("#settingupdate select[name=\"stockids[]\"]").select2();
