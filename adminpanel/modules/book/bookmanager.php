...
<body>
                                ...
                                <form id="filter">
                                    <div class="form-row">
                                        <div class="form-group col-md-10 ">
                                            <h4 class="page-title ">Registered book</h4>
                                        </div>
                                        <div class="form-group col-md-2 ">
                                            <button type="button" class="btn btn-primary w-100 d-none" data-toggle="modal" data-target="#exampleModal">Add book</button>
                                        </div>
                            ...
                            <form id="addbook" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="subject" class="select2" width="100%">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary upload_btn">Add book</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="bookupdate" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="inputEmail4">Name</label>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary update_btn">Update book</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        $('#addbook select[name="status"]').select2();
        $('#addbook select[name="domain"]').select2();
        $('#addbook select[name="message"]').select2();
        $('#bookupdate select[name="message"]').select2();
        $('.select2').css('width', '100%');
        $("#bookupdate select[name=\"stockids[]\"]").select2();
