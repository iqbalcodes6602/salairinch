            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="../../assets/images/logo.png" alt="logo" width="150" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text"  name='email' id="email" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        ...
                                        <button class="btn btn-success float-right" id="loginbtn" type="submit">Login</button>
                                    </div>
                                </div>
                            </div>
                        </div>
