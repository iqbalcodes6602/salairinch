...
<body>
                                ...
                                <form id="filter" >
                                    <div class="form-row">
                                        <div class="form-group col-md-10 ">
                                            <h4 class="page-title ">Registered Contactus</h4>
                                        </div>
                                        <div class="form-group col-md-2 ">
                                            <button type="button" class="btn btn-primary w-100 d-none" data-toggle="modal" data-target="#exampleModal">Add Contactus</button>
                                        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Contactus</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="addcontactus" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="inputEmail4">Name</label>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary upload_btn">Add Contactus</button>
                                    </div>
                                </div>
                            </form> 
                        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Contactus</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <form id="contactusupdate" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <label for="inputEmail4">Name</label>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="btn btn-primary update_btn">Update Contactus</button>
                                    </div>
                                </div>
                            </form> 
                        </div>
    ...
    <script src="contactusmanager.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script>
        $('#zero_config').DataTable();
        $('#filter_domain').select2();
        $('#addcontactus select[name="status"]').select2();
        $('#addcontactus select[name="domain"]').select2();
        $('#addcontactus select[name="type"]').select2();
        $('.select2').css('width','100%');
        $("#contactusupdate select[name=\"stockids[]\"]").select2();
